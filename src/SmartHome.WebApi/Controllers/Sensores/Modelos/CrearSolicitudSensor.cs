...
namespace SmartHome.WebApi.Controllers.Sensores.Modelos;

public sealed record CrearSolicitudSensor
{
    ...
    public CrearSensoresArgs Args(Usuario usuario)
    {
