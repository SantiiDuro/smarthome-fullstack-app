...
[TestClass]
public class ControladorSensorVentanaTest
{
    ...
    private ControladorSensorVentana _controlador = null!;
    ...
    public void Initialize()
    {
        ...
        _controlador = new ControladorSensorVentana(_logicaDispositivoMock.Object, _logicaSesionMock.Object);
    }
    ...
    public void CrearConArgsNullLanzaExcepcion()
    {
        ...
        _controlador.AgregarSensorVentana(null, auth);
    }
    ...
    public void CrearConNombreNullOVacioLanzaExcepcion(string nombre)
    {
        ...
        var auth = Guid.NewGuid().ToString();
        _controlador.AgregarSensorVentana(_solicitud, auth);
    }
    ...
    public void CrearConSolicitudValidaAgregaSensor()
    {
        ...
        var auth = Guid.NewGuid().ToString();
        _controlador.AgregarSensorVentana(solicitud, auth);

        _logicaDispositivoMock.Verify(s => s.AgregarSensorVentana(It.Is<CrearSensoresArgs>(a =>
